...
│   └── rsync-typegen/      # Type generation binary: exports TS types via ts-rs
...
└── src/                    # React frontend
    ...
    └── types/              # TypeScript types (barrel re-exports from generated/)
        └── generated/      # Auto-generated by ts-rs (do not edit)
```
...
npm run dev                    # Generate types + start Vite dev server (port 1420)
npm run build                  # Generate types + TypeScript check + Vite build
npm run generate-types         # Regenerate TS types from Rust models
...
TypeScript types in `src/types/generated/` are auto-generated from Rust models via ts-rs. The `rsync-typegen` crate (`cargo run -p rsync-typegen` or `npm run generate-types`) exports all IPC-crossing types. Domain barrel files in `src/types/` re-export from generated files, preserving frontend import paths. Never hand-edit files in `src/types/generated/`.
...
- Do not hand-edit files in `src/types/generated/` — these are auto-generated by ts-rs
